...
const BottomTabs = () => {
    ...
    return (
      ...
      <Tabs.Navigator screenOptions={{ headerShown: false, tabBarStyle: { backgroundColor: '#1a181fff',  height: 70, paddingBottom: 10, paddingTop: 10 }, tabBarLabelStyle: { fontSize: 12 } }} >
          ...
          <Tabs.Screen name="Matches" component={MatchesTabs} options={{
              headerShown: false,
              tabBarIcon: ({ focused }) => (
